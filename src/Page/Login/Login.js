...
const Login = () => {
    ...
    const { signIn, googleProviderLogin , gitProviderLogin, setLoading } = useContext(AuthContext);
            ...
            <div className=" grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 dark:bg-gray-800 dark:text-gray-100">
                ...
                <div className="flex flex-col justify-between">
                    <div className="space-y-2 mt-32">
                        <h2 className="text-4xl font-bold leading-tight lg:text-5xl">Welcome Back</h2>
                        <div className="dark:text-gray-400 font-bold">Login in your Account</div>
                    </div>
                </div>
