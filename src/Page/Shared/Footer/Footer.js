...
const Footer = () => {
    return (
        <div>
            <footer className="p-4 px-2 divide-y bg-gray-800 text-gray-100">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            ...
                            <span className="self-center text-2xl font-semibold"><span className='text-indigo-400'>edu</span>cal</span>
                        </a>
                    </div>
                ...
                <div className="py-2 text-sm text-center text-gray-400">© 2022 educal by Tajin Shawon All rights reserved.</div>
            </footer>
        </div>
    );
};
